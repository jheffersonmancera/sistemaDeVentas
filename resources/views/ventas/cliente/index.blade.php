	...
	<div class="row">
		...
		<div class="table-responsive">
			<table class="table table-striped table-bordered table-condensed table-hover">
				...
				@foreach($personas as $per)<!--15-36--><!--personas proviene del metodo index en ClienteController-->
				<tr>
					<td>{{$per->idpersona}}</td>
					<td>{{$per->nombre}}</td>
					...
					<td>{{$per->email}}</td>
					<td>
					    <!--llamo a ClienteController y el metodo edit y enviamos el idpersona-->
